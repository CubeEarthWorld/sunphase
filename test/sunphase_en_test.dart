...
void main() {
  ...
  group('Sunphase Parser Tests for English', () {
    ...
    test('English: "next week Sunday"', () {
      String input = "next week Sunday";
      List<ParsingResult> results = parse(
        input,
        referenceDate: reference,
        languages: ['en'],
    ...
    test('English: "next week Sunday" with Monday week start', () {
      String input = "next week Sunday";
      List<ParsingResult> results = parse(
        input,
        referenceDate: reference,
    ...
    test('English (Range): "next week" with Monday week start', () {
      String input = "next week go to university";
      List<ParsingResult> results = parse(
        input,
        referenceDate: reference,
